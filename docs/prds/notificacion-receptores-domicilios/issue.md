...
[F3] Notificación y flujo post-monitor. Este ticket cubre coordinar notificación, leer estampados del receptor y gatillar embargo al validar notificación efectiva. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Entregar la capacidad completa para coordinar notificación, leer estampados del receptor y gatillar embargo al validar notificación efectiva.
...
- **RF-01:** El módulo debe cubrir de punta a punta el alcance definido: coordinar notificación, leer estampados del receptor y gatillar embargo al validar notificación efectiva.
- **RF-02:** La notificación efectiva validada habilita embargo directo; las excepciones corren en paralelo y no bloquean.
- **RF-03:** Los estampados se clasifican como notificación efectiva, búsqueda positiva o búsqueda negativa.
- **RF-04:** Cada intento se cruza con la pauta de la financiera: Tanner 2, OLX hasta 5.
- **RF-05:** Si el nombre del estampado no calza con el deudor, se marca posible estampado en causa incorrecta.
...
- [ ] AC-01: El flujo principal de `notificacion-receptores-domicilios` queda representado con estados, entradas y salidas verificables.
