...
[F3] Notificación y flujo post-monitor. Este ticket cubre proponer escritos de nuevo domicilio, exhorto u oficios cuando falla la notificación. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para proponer escritos de nuevo domicilio, exhorto u oficios cuando falla la notificación.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Proponer escritos de nuevo domicilio, exhorto u oficios cuando falla la notificación. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir proponer escritos de nuevo domicilio, exhorto u oficios cuando falla la notificación.
- **RF-02:** Nuevo domicilio en Santiago usa flujo sin exhorto.
- **RF-03:** Domicilio regional usa exhorto.
- **RF-04:** Sin domicilios conocidos, se proponen oficios a fuentes autorizadas.
...
- [ ] AC-01: Búsqueda negativa puede generar borrador de nuevo domicilio.
- [ ] AC-02: Región genera opción con exhorto.
- [ ] AC-03: Agotadas direcciones, se propone solicitud de oficios.
- [ ] AC-04: El abogado aprueba antes de presentar.
