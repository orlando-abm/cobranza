...
[F3] Notificación y flujo post-monitor. Este ticket cubre gatillar preparación de embargo inmediatamente tras notificación efectiva validada. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para gatillar preparación de embargo inmediatamente tras notificación efectiva validada.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Gatillar preparación de embargo inmediatamente tras notificación efectiva validada. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir gatillar preparación de embargo inmediatamente tras notificación efectiva validada.
- **RF-02:** No esperar excepciones para avanzar embargo.
- **RF-03:** Antes de encargar, validar CAV, exhorto y propietario.
- **RF-04:** Hito de notificación 10% queda respaldado por estampado.
...
- [ ] AC-01: Notificación efectiva validada cambia la causa a lista para embargo.
- [ ] AC-02: Se genera propuesta de encargo de embargo.
- [ ] AC-03: Excepciones en apremio se muestran en paralelo.
- [ ] AC-04: Si prevalidación falla, el embargo queda bloqueado con motivo.
