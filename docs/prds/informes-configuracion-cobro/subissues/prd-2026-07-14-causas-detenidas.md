...
[F5] Configuración, informes y cobro. Este ticket cubre detectar causas sin movimiento y proponer causa probable del atasco. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para detectar causas sin movimiento y proponer causa probable del atasco.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Detectar causas sin movimiento y proponer causa probable del atasco. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir detectar causas sin movimiento y proponer causa probable del atasco.
- **RF-02:** Umbrales 15/30 días deben ser configurables.
- **RF-03:** Debe distinguir falta de movimiento real versus espera válida.
- **RF-04:** Debe sugerir causa probable como exhorto, CAV o reposición pendiente.
...
- [ ] AC-01: Lista causas detenidas con días sin movimiento.
- [ ] AC-02: Muestra causa probable.
- [ ] AC-03: Permite abrir la causa.
- [ ] AC-04: No altera estado judicial automáticamente.
