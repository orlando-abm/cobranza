...
[F5] Configuración, informes y cobro. Este ticket cubre mantener base de receptores por zona, tarifa, performance y estado activo. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para mantener base de receptores por zona, tarifa, performance y estado activo.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Mantener base de receptores por zona, tarifa, performance y estado activo. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir mantener base de receptores por zona, tarifa, performance y estado activo.
- **RF-02:** La selección puede depender de zona y disponibilidad.
- **RF-03:** Performance es insumo operativo, no decisión legal.
- **RF-04:** Sin receptor apto se bloquea encargo automático.
...
- [ ] AC-01: Se listan receptores con zona, tarifa y performance.
- [ ] AC-02: Puede activarse o desactivarse receptor.
- [ ] AC-03: El encargo usa receptor activo.
- [ ] AC-04: La falta de receptor genera bloqueo visible.
