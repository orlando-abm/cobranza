...
[F5] Configuración, informes y cobro. Este ticket cubre configurar modalidad, intentos, criterios de rebaja, política CAV y umbral OCR por financiera. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para configurar modalidad, intentos, criterios de rebaja, política CAV y umbral OCR por financiera.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Configurar modalidad, intentos, criterios de rebaja, política CAV y umbral OCR por financiera. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir configurar modalidad, intentos, criterios de rebaja, política CAV y umbral OCR por financiera.
- **RF-02:** El agente no inventa criterio de negocio.
- **RF-03:** Tanner y OLX pueden tener límites distintos.
- **RF-04:** Cambios de pauta afectan decisiones futuras, no reescriben historial.
...
- [ ] AC-01: Se puede configurar intentos máximos por financiera.
- [ ] AC-02: Se guarda umbral OCR por financiera.
- [ ] AC-03: Se registra política CAV y criterio de rebaja.
- [ ] AC-04: Las validaciones usan la pauta activa.
...
- Fase asignada: [F5] Configuración, informes y cobro. Esta fase ordena implementación y prioridad, pero no cambia el slug ni el parent de Linear.
...
- Inventar reglas de negocio no configuradas.
- Facturar hitos sin documento fundante.
