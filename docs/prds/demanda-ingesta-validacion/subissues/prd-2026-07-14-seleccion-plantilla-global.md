...
[F1] Creación de demandas. Este ticket cubre elegir la plantilla GLOBAL correcta según deudor, avales, sociedad y jurisdicción. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para elegir la plantilla GLOBAL correcta según deudor, avales, sociedad y jurisdicción.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Elegir la plantilla GLOBAL correcta según deudor, avales, sociedad y jurisdicción. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir elegir la plantilla GLOBAL correcta según deudor, avales, sociedad y jurisdicción.
- **RF-02:** Las seis plantillas válidas son GLOBAL 1/2 con o sin exhorto y variantes SOC.
- **RF-03:** Debe contar partes y avales desde pagaré.
- **RF-04:** La jurisdicción define si requiere exhorto.
...
- [ ] AC-01: Persona natural Santiago sin aval usa GLOBAL 1 SIN EXHORTO.
- [ ] AC-02: Regiones usan variante CON EXHORTO.
- [ ] AC-03: Sociedad con representante y aval usa plantilla SOC cuando corresponde.
- [ ] AC-04: El usuario puede reasignar plantilla y regenerar borrador.
