...
[F1] Creación de demandas. Este ticket cubre evitar demandar o embargar un vehículo cuyo propietario CAV no calza con deudor o aval. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para evitar demandar o embargar un vehículo cuyo propietario CAV no calza con deudor o aval.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Evitar demandar o embargar un vehículo cuyo propietario CAV no calza con deudor o aval. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir evitar demandar o embargar un vehículo cuyo propietario CAV no calza con deudor o aval.
- **RF-02:** Se lee la última página del CAV y el campo propietario.
- **RF-03:** Propietario transferido a tercero produce decisión humana.
- **RF-04:** Propietario igual a aval puede ser válido según estructura de partes.
...
- [ ] AC-01: El sistema compara propietario CAV contra deudor principal y avales.
- [ ] AC-02: Vehículo transferido queda marcado con alerta legal.
- [ ] AC-03: El caso no entra a lote automático de embargo si el propietario no calza.
- [ ] AC-04: La decisión humana queda registrada con motivo.
