...
[F3] Notificación y apremio paralelo. Este ticket cubre pre-generar certificado de no oposición cuando vence el plazo sin excepciones. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para pre-generar certificado de no oposición cuando vence el plazo sin excepciones.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Pre-generar certificado de no oposición cuando vence el plazo sin excepciones. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir pre-generar certificado de no oposición cuando vence el plazo sin excepciones.
- **RF-02:** Debe comprobar vencimiento del plazo de 8 días.
- **RF-03:** Debe verificar ausencia de excepciones en apremio.
- **RF-04:** El escrito queda para firma/presentación humana.
...
- [ ] AC-01: Vencido el plazo sin oposición, se genera borrador de certificado.
- [ ] AC-02: El borrador incluye fecha de requerimiento y causa.
- [ ] AC-03: No se presenta automáticamente.
- [ ] AC-04: La acción queda registrada en expediente.
