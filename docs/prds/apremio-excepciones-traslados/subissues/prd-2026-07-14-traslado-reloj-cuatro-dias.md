...
[F3] Notificación y apremio paralelo. Este ticket cubre detectar traslado en apremio y activar reloj de 4 días para respuesta humana. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para detectar traslado en apremio y activar reloj de 4 días para respuesta humana.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Detectar traslado en apremio y activar reloj de 4 días para respuesta humana. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir detectar traslado en apremio y activar reloj de 4 días para respuesta humana.
- **RF-02:** La respuesta la decide y redacta el abogado.
- **RF-03:** El agente puede preparar estructura editable si hay plantilla.
- **RF-04:** Debe alertar diariamente hasta resolución.
...
- [ ] AC-01: Un traslado crea reloj de 4 días.
- [ ] AC-02: Aparece en Vence pronto y Revisiones.
- [ ] AC-03: El agente no marca resuelto sin acción humana.
- [ ] AC-04: La causa mantiene avance principal cuando corresponda.
