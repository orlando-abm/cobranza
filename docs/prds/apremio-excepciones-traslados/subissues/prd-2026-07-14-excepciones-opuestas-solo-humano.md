...
[F3] Notificación y apremio paralelo. Este ticket cubre detectar excepciones del deudor y escalar como máxima prioridad humana. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para detectar excepciones del deudor y escalar como máxima prioridad humana.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Detectar excepciones del deudor y escalar como máxima prioridad humana. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir detectar excepciones del deudor y escalar como máxima prioridad humana.
- **RF-02:** Línea roja: el agente jamás contesta excepciones.
- **RF-03:** Debe clasificar la causa como con excepciones.
- **RF-04:** Debe incluir documento del deudor para revisión.
...
- [ ] AC-01: Una excepción detectada crea tarea crítica humana.
- [ ] AC-02: La causa queda marcada para informe a financiera.
- [ ] AC-03: No se genera respuesta automática de fondo.
- [ ] AC-04: El plazo asociado queda visible si existe traslado.
