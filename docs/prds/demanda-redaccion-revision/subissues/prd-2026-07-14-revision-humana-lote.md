...
[F1] Creación de demandas. Este ticket cubre dar al abogado una revisión consolidada de RUT, nombres, monto y financiera antes de avanzar. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para dar al abogado una revisión consolidada de RUT, nombres, monto y financiera antes de avanzar.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Dar al abogado una revisión consolidada de RUT, nombres, monto y financiera antes de avanzar. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir dar al abogado una revisión consolidada de RUT, nombres, monto y financiera antes de avanzar.
- **RF-02:** La revisión humana precede cualquier presentación.
- **RF-03:** Debe permitir abrir PDF origen en un clic.
- **RF-04:** Los casos con alertas quedan fuera de autorización masiva.
...
- [ ] AC-01: La pantalla lista demandas redactadas y bloqueadas por motivo.
- [ ] AC-02: El abogado puede validar campos críticos por lote.
- [ ] AC-03: Los casos bloqueados requieren corrección individual.
- [ ] AC-04: La autorización queda registrada por usuario y fecha.
