...
[F1] Creación de demandas. Este ticket cubre separar demandas de causas, mostrando solo estados previos al Rol. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para separar demandas de causas, mostrando solo estados previos al Rol.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Separar demandas de causas, mostrando solo estados previos al Rol. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir separar demandas de causas, mostrando solo estados previos al Rol.
- **RF-02:** Estados permitidos: `revisar` y `redactada`.
- **RF-03:** No se muestra Rol en demandas no presentadas.
- **RF-04:** El buscador debe operar por crédito, RUT, partes y financiera.
...
- [ ] AC-01: Una demanda redactada puede abrirse o ingresarse manualmente como causa.
- [ ] AC-02: Una demanda por revisar muestra motivo visible.
- [ ] AC-03: Al ingresar Rol, la demanda sale de esta bandeja.
- [ ] AC-04: No aparecen causas ya activas como demandas.
