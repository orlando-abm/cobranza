...
[F1] Creación de demandas. Este ticket cubre mostrar contexto, confianza y propuestas del procurador en una demanda individual. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para mostrar contexto, confianza y propuestas del procurador en una demanda individual.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Mostrar contexto, confianza y propuestas del procurador en una demanda individual. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir mostrar contexto, confianza y propuestas del procurador en una demanda individual.
- **RF-02:** El procurador puede sugerir plantilla o abrir borrador, no presentar sin acción humana.
- **RF-03:** La confianza debe explicar por qué una demanda está lista o dudosa.
- **RF-04:** Debe mantener documentos origen disponibles.
...
- [ ] AC-01: El detalle muestra estado, datos, plantilla y confianza.
- [ ] AC-02: El chat propone acciones reabribles sin marcarlas como completadas automáticamente.
- [ ] AC-03: Las propuestas respetan `revisar` versus `redactada`.
- [ ] AC-04: El usuario puede pasar desde detalle a ingreso manual de causa.
