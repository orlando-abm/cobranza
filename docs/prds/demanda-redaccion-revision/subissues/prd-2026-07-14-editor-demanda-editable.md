...
[F1] Creación de demandas. Este ticket cubre permitir revisar y editar el borrador de demanda generado antes de ingresarlo como causa. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para permitir revisar y editar el borrador de demanda generado antes de ingresarlo como causa.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Permitir revisar y editar el borrador de demanda generado antes de ingresarlo como causa. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir permitir revisar y editar el borrador de demanda generado antes de ingresarlo como causa.
- **RF-02:** Todo documento generado debe abrirse en editor tipo Word.
- **RF-03:** Guardar cambios no equivale a presentar.
- **RF-04:** La edición debe conservar trazabilidad del borrador.
...
- [ ] AC-01: El usuario puede abrir la demanda generada desde el detalle.
- [ ] AC-02: Puede corregir texto y marcar la demanda como redactada.
- [ ] AC-03: El borrador conserva datos principales del crédito.
- [ ] AC-04: No existe acción de submit PJUD dentro del editor v1.
