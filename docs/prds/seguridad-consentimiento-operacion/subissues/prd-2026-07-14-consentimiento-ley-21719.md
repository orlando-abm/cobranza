...
[F6] Seguridad y automatización PJUD posterior. Este ticket cubre registrar consentimiento y trazabilidad para tratamiento de datos y uso futuro de credenciales. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para registrar consentimiento y trazabilidad para tratamiento de datos y uso futuro de credenciales.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Registrar consentimiento y trazabilidad para tratamiento de datos y uso futuro de credenciales. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir registrar consentimiento y trazabilidad para tratamiento de datos y uso futuro de credenciales.
- **RF-02:** No es prioridad funcional de demanda/manual, pero es requisito antes de automatizar accesos.
- **RF-03:** Debe quedar asociado a abogado/estudio.
- **RF-04:** Sin consentimiento no se habilitan flujos con credenciales.
...
- [ ] AC-01: Existe estado de consentimiento por abogado o estudio.
- [ ] AC-02: Se registra fecha, versión y alcance.
- [ ] AC-03: Flujos con credenciales quedan bloqueados sin consentimiento.
- [ ] AC-04: El consentimiento no se infiere automáticamente.
