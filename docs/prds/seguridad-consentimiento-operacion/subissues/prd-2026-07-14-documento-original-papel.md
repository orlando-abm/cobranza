...
[F6] Seguridad y automatización PJUD posterior. Este ticket cubre registrar pagarés u originales físicos que deben custodiarse o entregarse. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para registrar pagarés u originales físicos que deben custodiarse o entregarse.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Registrar pagarés u originales físicos que deben custodiarse o entregarse. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir registrar pagarés u originales físicos que deben custodiarse o entregarse.
- **RF-02:** Al presentar manualmente, el estudio puede necesitar marcar original en papel.
- **RF-03:** El sistema debe rastrear pendiente/entregado cuando aplique.
- **RF-04:** No sustituye custodia física.
...
- [ ] AC-01: Una causa puede marcar documento original pendiente.
- [ ] AC-02: Se registra tipo de original y estado.
- [ ] AC-03: El estado aparece como bloqueo o recordatorio operativo.
- [ ] AC-04: No se permite cerrar trazabilidad sin actor/fecha.
