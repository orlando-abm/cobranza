...
[F2] Ingreso manual y monitoreo PJUD. Este ticket cubre detectar resoluciones que piden subsanar y activar reloj/planteamiento de cumple lo ordenado. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para detectar resoluciones que piden subsanar y activar reloj/planteamiento de cumple lo ordenado.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Detectar resoluciones que piden subsanar y activar reloj/planteamiento de cumple lo ordenado. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir detectar resoluciones que piden subsanar y activar reloj/planteamiento de cumple lo ordenado.
- **RF-02:** Leer contenido de la resolución y plazo, no solo título.
- **RF-03:** Cruzar rebaja solicitada con pauta de financiera.
- **RF-04:** Si excede pauta, escalar a decisión humana.
...
- [ ] AC-01: Un previo a proveer crea reloj desde día 0.
- [ ] AC-02: Si la rebaja está dentro de pauta, se pre-genera borrador editable.
- [ ] AC-03: Si excede pauta, se alerta evaluación de reposición.
- [ ] AC-04: El estado queda visible en causa y revisiones.
