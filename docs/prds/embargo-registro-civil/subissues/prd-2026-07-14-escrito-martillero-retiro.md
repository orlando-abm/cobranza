...
[F4] Embargo y Registro Civil. Este ticket cubre prellenar escrito de designación de martillero y retiro tras embargo inscrito. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para prellenar escrito de designación de martillero y retiro tras embargo inscrito.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Prellenar escrito de designación de martillero y retiro tras embargo inscrito. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir prellenar escrito de designación de martillero y retiro tras embargo inscrito.
- **RF-02:** Solo se habilita tras inscripción aceptada.
- **RF-03:** Debe incluir patente, rol, tribunal, partes y martillero.
- **RF-04:** La incautación posterior queda fuera del MVP.
...
- [ ] AC-01: El escrito se genera como borrador editable.
- [ ] AC-02: No aparece si el embargo solo tiene comprobante de ingreso.
- [ ] AC-03: Incluye datos de causa y bien embargado.
- [ ] AC-04: Requiere firma/presentación humana.
