...
[F4] Embargo y Registro Civil. Este ticket cubre escalar rechazos de inscripción para decisión humana. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para escalar rechazos de inscripción para decisión humana.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Escalar rechazos de inscripción para decisión humana. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir escalar rechazos de inscripción para decisión humana.
- **RF-02:** Un rechazo no avanza etapa.
- **RF-03:** Debe mostrar razón si la fuente la entrega.
- **RF-04:** Puede indicar posible transferencia del vehículo.
...
- [ ] AC-01: Inscripción rechazada crea alerta humana.
- [ ] AC-02: La causa no marca hito 15%.
- [ ] AC-03: La razón del rechazo queda registrada.
- [ ] AC-04: El abogado decide actualización, informe o nueva estrategia.
