...
[F4] Embargo y Registro Civil. Este ticket cubre disparar cadena de cierre al confirmar inscripción aceptada. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para disparar cadena de cierre al confirmar inscripción aceptada.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Disparar cadena de cierre al confirmar inscripción aceptada. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir disparar cadena de cierre al confirmar inscripción aceptada.
- **RF-02:** Inscripción aceptada cierra hito de embargo inscrito.
- **RF-03:** Debe avisar al abogado, preparar mail a financiera y alimentar informe.
- **RF-04:** El escrito de martillero queda como paso posterior editable.
...
- [ ] AC-01: La causa marca embargo inscrito solo con aceptación RC/CAV.
- [ ] AC-02: Se registra hito de cobro 15% con fecha y documento.
- [ ] AC-03: Se genera aviso y mail/informe del período.
- [ ] AC-04: El siguiente escrito queda disponible para firma humana.
