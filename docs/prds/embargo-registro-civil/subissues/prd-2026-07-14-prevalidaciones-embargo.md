...
[F4] Embargo y Registro Civil. Este ticket cubre bloquear encargos de embargo que requieren CAV del mes, retorno de exhorto o decisión por propietario. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para bloquear encargos de embargo que requieren CAV del mes, retorno de exhorto o decisión por propietario.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Bloquear encargos de embargo que requieren CAV del mes, retorno de exhorto o decisión por propietario. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir bloquear encargos de embargo que requieren CAV del mes, retorno de exhorto o decisión por propietario.
- **RF-02:** Algunos tribunales exigen CAV previo al embargo.
- **RF-03:** Si la notificación fue por exhorto regional, esperar retorno.
- **RF-04:** Propietario transferido bloquea lote automático.
...
- [ ] AC-01: Cada causa lista para embargo pasa por prevalidaciones.
- [ ] AC-02: Casos con CAV requerido quedan bloqueados.
- [ ] AC-03: Exhorto sin retorno bloquea encargo.
- [ ] AC-04: Solo casos sin bloqueo entran a lote automático.
