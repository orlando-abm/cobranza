...
[F2] Ingreso manual y monitoreo PJUD. Este ticket cubre leer movimientos judiciales reales y clasificarlos por contenido del documento, no por el título del PJUD. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Entregar la capacidad completa para leer movimientos judiciales reales y clasificarlos por contenido del documento, no por el título del PJUD.
...
- **RF-01:** El módulo debe cubrir de punta a punta el alcance definido: leer movimientos judiciales reales y clasificarlos por contenido del documento, no por el título del PJUD.
- **RF-02:** Aviso, estado y gatillante son conceptos distintos; el gatillante sale del PDF validado.
- **RF-03:** El monitor debe considerar cuaderno principal y cuaderno de apremio en paralelo.
- **RF-04:** Baja confianza nunca gatilla avance: deriva a revisión humana.
- **RF-05:** La vista Estado diario es respaldo auditable; el agente prioriza lo accionable en el Inicio.
...
- [ ] AC-01: El flujo principal de `monitor-pjud-clasificacion` queda representado con estados, entradas y salidas verificables.
