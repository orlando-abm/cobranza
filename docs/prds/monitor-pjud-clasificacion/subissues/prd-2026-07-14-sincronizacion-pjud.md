...
[F2] Ingreso manual y monitoreo PJUD. Este ticket cubre sincronizar causas activas con PJUD de forma recurrente y conservadora. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para sincronizar causas activas con PJUD de forma recurrente y conservadora.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Sincronizar causas activas con PJUD de forma recurrente y conservadora. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir sincronizar causas activas con PJUD de forma recurrente y conservadora.
- **RF-02:** Frecuencia de referencia cada 4 horas.
- **RF-03:** Debe leer ambos cuadernos.
- **RF-04:** Si PJUD falla, conservar valor con base interna y reportar warning.
...
- [ ] AC-01: La sincronización registra movimientos nuevos por causa.
- [ ] AC-02: No duplica actuaciones ya vistas.
- [ ] AC-03: Fallas de conexión no borran estado local.
- [ ] AC-04: El resultado alimenta Estado diario y bandejas priorizadas.
