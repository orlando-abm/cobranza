...
[F5] Operación diaria y acciones en lote. Este ticket cubre guardar notas y recordatorios internos por causa sin tratarlos como plazos legales. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para guardar notas y recordatorios internos por causa sin tratarlos como plazos legales.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Guardar notas y recordatorios internos por causa sin tratarlos como plazos legales. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir guardar notas y recordatorios internos por causa sin tratarlos como plazos legales.
- **RF-02:** Recordatorios internos no compiten con relojes judiciales.
- **RF-03:** Notas deben estar disponibles para el procurador.
- **RF-04:** Deben poder asociarse a causa o quedar generales.
...
- [ ] AC-01: El usuario puede crear recordatorio desde chat.
- [ ] AC-02: Recordatorios vencidos aparecen en Home como no legales.
- [ ] AC-03: Una nota queda visible en la causa.
- [ ] AC-04: El agente puede considerar notas al proponer pasos.
