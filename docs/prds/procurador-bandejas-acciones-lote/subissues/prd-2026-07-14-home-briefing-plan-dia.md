...
[F5] Operación diaria y acciones en lote. Este ticket cubre resumir movimientos PJUD y proponer un plan diario priorizado. El dolor operativo de Cobranza Judicial es que el seguimiento manual de cientos de causas provoca atrasos, omisiones y pérdida de recuperación. El PRD debe dejar claro qué puede resolver el agente, qué queda bajo aprobación y qué se deriva a revisión humana.

## 2. Objetivos

- [ ] OBJ-01: Implementar el flujo para resumir movimientos PJUD y proponer un plan diario priorizado.
...
| Como... | Quiero... | Para... |
|---------|-----------|---------|
| Abogado/a o procurador/a | Resumir movimientos PJUD y proponer un plan diario priorizado. | avanzar causas sin perder control sobre decisiones legales |
...
- **RF-01:** El sistema debe permitir resumir movimientos PJUD y proponer un plan diario priorizado.
- **RF-02:** Urgencias legales van primero.
- **RF-03:** El plan debe explicar qué puede avanzar el agente y qué decide el humano.
- **RF-04:** Debe excluir causas suspendidas o eliminadas.
...
- [ ] AC-01: El Home muestra grupos de movimientos del día.
- [ ] AC-02: Presenta plan de trabajo accionable.
- [ ] AC-03: Vence pronto lista plazos críticos.
- [ ] AC-04: Las métricas de lote abren flujos concretos.
